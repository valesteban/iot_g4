...
# Form implementation generated from reading ui file '/home/malva/esp/iot_g4/Tarea2/Raspberry/extra/qt/main_display.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_search_refresh.setEnabled(True)
        self.pushButton_search_refresh.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon_refresh/images/refresh_active.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/icon_refresh/images/refresh_disabled.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/icon_refresh/images/refresh_disabled.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        ...
        self.scrollAreaWidgetContents_added_plots.setGeometry(QtCore.QRect(0, 0, 98, 28))
